...
|---|---|---|
| [market-pulse](https://github.com/marcopavez/market-pulse) | Plataforma de datos financieros | Python |
| [claude-impact-lab](https://github.com/marcopavez/claude-impact-lab) | Hackathon IA — Claude Impact Lab | TypeScript |
| [estrategias-trading](https://github.com/marcopavez/estrategias_trading) | Backtesting de estrategias de trading | Python |
| [yt-pipeline](https://github.com/marcopavez/yt-pipeline) | Pipeline de datos de YouTube | TypeScript |
...
- Instagram: [@n.u_crx.mo](https://www.instagram.com/n.u_crx.mo/)
